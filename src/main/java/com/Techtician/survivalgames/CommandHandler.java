...
import com.Techtician.survivalgames.commands.*;
	...
	public boolean onCommand(CommandSender sender, Command cmd1, String commandLabel, String[] args) {
		...
		if (cmd1.getName().equalsIgnoreCase("survivalgames")) {
			if (args == null || args.length < 1) {
				msgmgr.sendMessage(PrefixType.INFO, "Version " + pdfFile.getVersion() + " originally by Techtician", sender);
				msgmgr.sendMessage(PrefixType.INFO, "Later fixes and updates by Techtician and kmaxi", sender);
